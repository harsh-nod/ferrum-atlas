...
export type StateMachineSelection = { snapshot_id: SnapshotId, context_id: ContextId, enum_path: string, state_place: string, };
export type StateMachineReviewRequest<T> = { selection: StateMachineSelection, review: T, };
...
export type StateMachineLimits = { max_body_bytes: number, max_nodes: number, max_transitions: number, max_unknowns: number, max_response_bytes: number, };
export type StateMachineInference = { envelope: AnalysisEnvelope, input_digest: string, definition_id: DefinitionId, enum_path: string, state_place: string, body_span: Span, visited_nodes: number, candidates: Array<StateTransitionCandidate>, unknowns: Array<StateMachineUnknown>, };
export type StateTransitionCandidate = { id: string, from_variant: string, to_variant: string, match_span: Span, arm_span: Span, assignment_span: Span, guard: StateMachineSyntax | null, action: StateMachineSyntax, };
export type StateMachineSyntax = { span: Span, text: string, };
